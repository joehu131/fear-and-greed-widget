// Fear & Greed Modern Pro Widget - Dark Mode
// Features: Dynamic Dark Gradient, Multi-Zone Visual Gauge, Small & Medium Adaptive Layouts, Offline Cache & CNN Deep Link.

const API_URL = "https://production.dataviz.cnn.io/index/fearandgreed/graphdata";
const CACHE_FILE = "fgi_modern_dark_cache.json";
const CNN_URL = "https://www.cnn.com/markets/fear-and-greed";

// Color Palette for Dark Theme
const PALETTE = {
  extremeFear: { hex: "#FF3B30", label: "Extreme Fear", bg: "#2A1416" },
  fear:        { hex: "#FF9500", label: "Fear",         bg: "#2A1E12" },
  neutral:     { hex: "#FFD60A", label: "Neutral",      bg: "#262414" },
  greed:       { hex: "#34C759", label: "Greed",        bg: "#122818" },
  extremeGreed:{ hex: "#00E676", label: "Extreme Greed",bg: "#0A281E" }
};

function log(message, ...args) {
  console.log(`[FGI Modern Dark] ${message}`, ...args);
}

function logError(message, ...args) {
  console.error(`[FGI Modern Dark] ERROR: ${message}`, ...args);
}
...
function getSentimentTheme(score) {
  if (typeof score !== "number" || isNaN(score)) {
    return { hex: "#EBEBF5", label: "Unknown", bg: "#1C1C1E" };
  }
...
// Draw modern multi-zone gauge (Dark theme track & glow)
